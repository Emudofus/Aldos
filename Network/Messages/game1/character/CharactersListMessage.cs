...
namespace Aldos.Network.Messages.game.character
{
	...
	{
		public Dictionary<int, Global.Character> Characters { get; set; }
		
		public CharactersListMessage(Dictionary<int, Global.Character> characters)
		{
			base.ID = PacketType.CharactersListMessage;
		...
		{
			serialize(this, new List<Global.Character>(Characters.Values));
			return base.Pack ();
		}
